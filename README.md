...
| `bitrise_devenv_update_warm_pool` | Scale a pool (`desired_count`; 0 drains it), rename it, or change its stored configuration (arrays replace all entries; `""` clears an override) |
