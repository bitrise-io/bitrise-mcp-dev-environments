# Install Bitrise Dev Environments MCP Server in Copilot IDEs
...
2. Bitrise Account: Bitrise account for Bitrise Dev Environments MCP server access
...
3. Try: *"List my dev environment sessions"*
4. Copilot can now access Bitrise Dev Environments and perform operations
