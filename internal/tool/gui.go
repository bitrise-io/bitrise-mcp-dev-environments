...
NOTE: This tool only works on macOS sessions.`),
	...
	Handler: func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		res, err := devenv.CallAPI(ctx, devenv.CallAPIParams{
			...
			Path:   devenv.WsPath(fmt.Sprintf("/v1/sessions/%s/click", sessionID)),
			Body:   body,
		})
		if err != nil {
...
NOTE: This tool only works on macOS sessions.`),
	...
	Handler: func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		res, err := devenv.CallAPI(ctx, devenv.CallAPIParams{
			Method: http.MethodPost,
			Path:   devenv.WsPath(fmt.Sprintf("/v1/sessions/%s/type", sessionID)),
...
NOTE: This tool only works on macOS sessions.`),
	...
	Handler: func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		res, err := devenv.CallAPI(ctx, devenv.CallAPIParams{
			Method: http.MethodPost,
			Path:   devenv.WsPath(fmt.Sprintf("/v1/sessions/%s/scroll", sessionID)),
			Body: map[string]any{
...
NOTE: This tool only works on macOS sessions.`),
	...
	Handler: func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		res, err := devenv.CallAPI(ctx, devenv.CallAPIParams{
			Method: http.MethodPost,
			Path:   devenv.WsPath(fmt.Sprintf("/v1/sessions/%s/mouse-drag", sessionID)),
			Body: map[string]any{
