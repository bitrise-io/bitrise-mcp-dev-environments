...
var ListSessions = devenv.Tool{
	...
	Handler: func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		res, err := devenv.CallAPI(ctx, devenv.CallAPIParams{
			...
			Path:   devenv.WsPath("/v1/sessions"),
		})
		if err != nil {
...
var GetSession = devenv.Tool{
	...
	Handler: func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		res, err := devenv.CallAPI(ctx, devenv.CallAPIParams{
			Method: http.MethodGet,
			Path:   devenv.WsPath(fmt.Sprintf("/v1/sessions/%s", sessionID)),
		})
		if err != nil {
...
var StartSession = devenv.Tool{
	...
	Handler: func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		res, err := devenv.CallAPI(ctx, devenv.CallAPIParams{
			Method: http.MethodPost,
			Path:   devenv.WsPath(fmt.Sprintf("/v1/sessions/%s/start", sessionID)),
			Body:   map[string]any{},
		})
		if err != nil {
...
var StopSession = devenv.Tool{
	...
	Handler: func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		res, err := devenv.CallAPI(ctx, devenv.CallAPIParams{
			Method: http.MethodPost,
			Path:   devenv.WsPath(fmt.Sprintf("/v1/sessions/%s/stop", sessionID)),
			Body:   map[string]any{},
		})
		if err != nil {
...
var DeleteArchivedSessions = devenv.Tool{
	...
	Handler: func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		res, err := devenv.CallAPI(ctx, devenv.CallAPIParams{
			Method: http.MethodPost,
			Path:   devenv.WsPath("/v1/sessions:delete-archived"),
			Body:   map[string]any{},
		})
		if err != nil {
