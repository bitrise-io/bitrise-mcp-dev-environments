...
var CreateTemplate = devenv.Tool{
	Definition: mcp.NewTool("bitrise_devenv_create_template",
		...
		mcp.WithString("image", mcp.Description("Machine image name (use bitrise_devenv_list_images to find the name, e.g. 'osx-xcode-edge')"), mcp.Required()),
...
var UpdateTemplate = devenv.Tool{
	Definition: mcp.NewTool("bitrise_devenv_update_template",
		...
		mcp.WithString("image", mcp.Description("Updated machine image name (use bitrise_devenv_list_images to find the name)")),
